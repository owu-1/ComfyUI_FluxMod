...
class FluxMod(nn.Module):
    """
    Transformer model for flow matching on sequences.
    """

    def __init__(self, params: FluxParams, image_model=None, final_layer=True, dtype=None, device=None, operations=nn, **kwargs):
        super().__init__()
        self.dtype = dtype
        self.params = params
    ...
    def forward(self, x, timestep, context, guidance, control=None, transformer_options={}, **kwargs):
        ...
        out = self.forward_orig(img, img_ids, context, txt_ids, timestep, guidance, control, transformer_options)
